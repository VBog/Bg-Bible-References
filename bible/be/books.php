<?php
	$bg_bibrefs_lang_name = 'Беларуская';
	$bg_bibrefs_book_lang = 'be';
	$bg_bibrefs_chapter = 'Раздзел';
	$bg_bibrefs_ch = 'рз.';
	$bg_bibrefs_psalm = 'Псальма';
	$bg_bibrefs_ps = 'пс.';
	...
	$bg_bibrefs_shortTitle = array(						// Книги Священного Писания
		// Ветхий Завет
		// Пятикнижие Моисея															
		'Gen'		=>"Быт.", 
		'Ex'		=>"Исх.", 
